...
### Aksanlar — 4 renk, HER SEPETE BİR RENK (`lib/accent.ts`)
| Token | Hex | Atama |
|---|---|---|
| `--coral` | `#F2795F` (light `#F5A98F`) | sosyal (id hash) |
| `--gold` | `#E7A93F` (light `#EEC078`) | **build / hackathon** (sabit) |
| `--green` | `#33C293` (light `#6FD9B4`) | sosyal (id hash) |
| `--blue` | `#6B8CF0` (light `#8FA8F5`) | sosyal (id hash) |

- `accentFor(basket)`: build → gold; sosyal → id hash ile coral/green/blue.
...
- ✅ 4 aksanlı çok-renk (coral/gold/green/blue). ❌ Mor.
